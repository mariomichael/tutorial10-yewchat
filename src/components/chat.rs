...
impl Component for Chat {
    ...
    fn view(&self, ctx: &Context<Self>) -> Html {
        ...
        html! {
            <div class="flex w-screen bg-gray-900 text-blue">
                <div class="flex-none w-56 h-screen bg-gray-100">
                    <div class="text-xl text-blue-500 p-3">{"Users"}</div>
                    {
                        self.users.clone().iter().map(|u| {
                            html!{
                                <div class="flex m-3 bg-green-700 rounded-lg p-2">
                                    <div>
                ...
                <div class="grow h-screen flex flex-col">
                    <div class="w-full h-14 border-b-2 border-gray-300"><div class="text-xl p-3">{"💬 Ada pesan apa hari ini?"}</div></div>
